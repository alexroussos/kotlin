...
public class KotlinFieldBreakpointPropertiesPanel: XBreakpointCustomPropertiesPanel<XLineBreakpoint<KotlinPropertyBreakpointProperties>>() {
    ...
    override fun getComponent(): JComponent {
        ...
        val listener = ActionListener {
            if (!myWatchAccessCheckBox.isSelected() &&
                !myWatchModificationCheckBox.isSelected() &&
                !myWatchInitializationCheckBox.isSelected()
            ) {
                when(it.getSource()) {
                    myWatchInitializationCheckBox -> myWatchInitializationCheckBox.setSelected(true)
        ...
        myWatchInitializationCheckBox.addActionListener(listener)
